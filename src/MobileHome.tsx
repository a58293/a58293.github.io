...
export default function MobileHome({onOpenFlowerGods,onOpenFeatured}:{onOpenFlowerGods?:()=>void;onOpenFeatured?:()=>void}) {
  ...
  return <div className="mh-page">
    <header className="mh-header"><a href="/" className="mh-brand"><img src={requiredImage('brandLogo')} alt="绘屿造物"/><span>LUMEN AURALIS<small>绘屿造物</small></span></a><a href="/verify">防伪核验 ↗</a></header>
    <main>
      ...
      <section className="mh-volume" id="series"><div className="mh-section-heading"><span>01 / THE COLLECTION</span><h2>一卷花事，<br/>各有其神。</h2><p>以花为引，将想象塑成可珍藏的形体。</p></div><a className="mh-series-card" href="/series/flower-gods" onClick={follow(onOpenFlowerGods)}><img src={requiredImage('flowerPavilion')} alt="花神卷建筑与云海" loading="lazy"/><span><b>花神卷</b><small>探索系列</small><i>↗</i></span></a></section>
